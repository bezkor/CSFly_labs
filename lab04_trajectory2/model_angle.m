...
% Модель польоту по лінії заданного шляху з азимутальною корекцією

  % Констатанти моделі
  Ka = 0.25; % Коефіціент закону керування по азимуту
  Kz = 2.5;   % Коефіціент закону керування по відхиленню
